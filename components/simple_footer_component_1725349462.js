...
<template>
    <footer id="footer-section" style="min-height: 350px" class="flex-1 bg-gradient-to-r from-pink-600 to-purple-800 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8">
        <div id="footer-container" class="max-w-screen-xl mx-auto">
            ...
            <div id="footer-content" class="text-center">
                <div class="flex">
                    <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-3xl font-bold text-white hover:text-pink-200 transition duration-300">
                        <img id="footer-logo" src="https://makeinfinite-mentat-dev.azurewebsites.net/get_image/Platform_Creation_App_1725349460/logo.svg" class="h-8 mr-3 sm:h-10" alt="Landwind Logo" />
                        PlatformCraft
                    </a>
                </div>
            </div>
            <div class="flex">
                <div id="footer-text" class="flex-1 block text-sm text-center text-pink-100 hover:text-white transition duration-300">
                    © 2023 PlatformCraft. Empowering creators to build the platforms of tomorrow.
                </div>
            </div>
        </div>
    </footer>
