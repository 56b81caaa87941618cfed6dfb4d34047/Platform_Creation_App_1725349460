...
<template>
    <footer id="footer-section" style="min-height: 270px"     class="flex-1 bg-gradient-to-r from-pink-600 to-purple-800 bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg p-8">
